...
save_dir = f'./results/PE/{sample_sizes[0]}/dyn'  # 你的存储路径，指定文件名，若没有，代码可以自动生成
...
for idx, sample_size in enumerate(sample_sizes):
    ...
    for t in np.arange(0, 200, 1):
        ...
        true_labels = []
        cluster_result = cluster_main1(df_data_obs, ModelEs_renum, marginal_prob, true_labels, 64, 10, random_seed=42)
